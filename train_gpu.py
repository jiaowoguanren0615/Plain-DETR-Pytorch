...
def get_args_parser():
    parser = argparse.ArgumentParser("Plain DETR Detector", add_help=False)
    ...
    parser.add_argument(
        "--backbone",
        default="swin_v2_small_window12to16_2global",
        type=str,
        choices=['swin_v2_small_window12to16_2global', 'swin_v2_small_window16_2global'],
    ...
    parser.add_argument("--dataset_file", default="coco", choices=['coco', 'voc'])
    parser.add_argument("--coco_path", default="./data/coco", type=str)
    parser.add_argument("--coco_panoptic_path", type=str)
    parser.add_argument("--remove_difficult", action="store_true")

    # PascalVOC dataset parameters
    parser.add_argument("--voc_data_root", default="./data/VOCdevkit")
    parser.add_argument("--year", default='2012', type=str, choices=['2007', '2012'],
                        help='version of pascal voc dataset')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        "Plain DETR training and evaluation script", parents=[get_args_parser()]
    )
